...
%%%% Bounary data Area(3) %%%%
Area(3).nb=1;
Area(3).bnd{1}=[Area(3).X(7:9,7:9),Area(3).X(7:9,1:3),Area(3).X(7:9,16:18),Area(3).X(7:9,10:12);...
			 Area(3).X(1:3,7:9),Area(3).X(1:3,1:3),Area(3).X(1:3,16:18),Area(3).X(1:3,10:12);...
			 Area(3).X(16:18,7:9),Area(3).X(16:18,1:3),Area(3).X(16:18,16:18),Area(3).X(16:18,10:12);...
			 Area(3).X(10:12,7:9),Area(3).X(10:12,1:3),Area(3).X(10:12,16:18),Area(3).X(10:12,10:12)];

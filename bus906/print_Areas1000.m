fid=fopen('bus205_54Area_data_length2.m','w');%%%%%%%%%%%%%change file name here
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fprintf(fid,'\t if node(Area(%d).node(n)).g==1\n',i);
fprintf(fid,'\t Area(%d).G_of_phases=Area(%d).G_of_phases+node(Area(%d).node(n)).np;\n',i,i,i);
fprintf(fid,'\t end\n');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fprintf(fid,'end\n');
fprintf(fid,'\n');
...
bus205_54Area_data_length2;%%%%%%%%%%%%%change file name here

fid=fopen('bus205_54Area_data_length3.m','a');%%%%%%%%%%%%%change file name here
for i= 1:size(Area_result,2)

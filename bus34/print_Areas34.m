fid=fopen('bus34_9Area_data_t3.m','w');%%%%%%%%%%%%%change file name here
...
bus34_9Area_data_t3;%%%%%%%%%%%%%change file name here

fid=fopen('bus34_9Area_data_t3.m','a');%%%%%%%%%%%%%change file name here
for i= 1:size(Area_result,2)
